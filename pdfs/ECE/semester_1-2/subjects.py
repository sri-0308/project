subjects = [
    {"name": "CHE – Chemistry", "units": [1, 2, 3, 4, 5]},
    {"name": "DE and VC – Differential Equations and Vector Calculus", "units": [1, 2, 3, 4, 5]},
    {"name": "Network Analysis – Network Analysis", "units": [1, 2, 3, 4, 5]},
    {"name": "BCME – Basic Civil and Mechanical Engineering", "units": [1, 2, 3, 4, 5]},
    {"name": "English – Communicative English", "units": [1, 2, 3, 4, 5]}
]
...
for subject in subjects:
    ...
    safe_filename = subject["name"].replace(" ", "_").replace("–", "_").replace("—", "_")
    with open(f"{safe_filename}_Materials.html", "w", encoding="utf-8") as file:
